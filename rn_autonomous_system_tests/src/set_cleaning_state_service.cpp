 ...
 *
 * Services:
 *   /set_cleaning_state (rn_autonomous_msgs/srv/SetCleaningState):
...
#include "rn_autonomous_msgs/srv/set_cleaning_state.hpp"
...
public:
  ...
  {
    service_ = this->create_service<rn_autonomous_msgs::srv::SetCleaningState>(
      "/set_cleaning_state",
...
private:
  ...
  void set_cleaning_state_callback(
    const std::shared_ptr<rn_autonomous_msgs::srv::SetCleaningState::Request> request,
    std::shared_ptr<rn_autonomous_msgs::srv::SetCleaningState::Response> response)
  {
  ...
  rclcpp::Service<rn_autonomous_msgs::srv::SetCleaningState>::SharedPtr service_;
};
