 ...
 *
 * Action Client:
 *   timed_rotation (rn_autonomous_msgs/action/TimedRotation):
...
#include "rn_autonomous_msgs/action/timed_rotation.hpp"
#include "std_msgs/msg/bool.hpp"

using TimedRotation = rn_autonomous_msgs::action::TimedRotation;
