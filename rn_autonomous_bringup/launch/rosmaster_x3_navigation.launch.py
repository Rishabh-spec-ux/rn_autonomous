...
def generate_launch_description():
    ...
    package_name_gazebo = 'rn_autonomous_gazebo'
    package_name_localization = 'rn_autonomous_localization'
    package_name_navigation = 'rn_autonomous_navigation'

    # Launch and config file paths
    
    gazebo_launch_file_path = 'launch/rn_autonomous.gazebo.launch.py'
    ekf_launch_file_path = 'launch/ekf_gazebo.launch.py'
    ekf_config_file_path = 'config/ekf.yaml'
    map_file_path = 'maps/house _world_map.yaml'
    ...
    start_assisted_teleop_cmd = Node(
        package='rn_autonomous_navigation',
